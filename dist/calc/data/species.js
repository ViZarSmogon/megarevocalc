...
var MegaRev_PATCH = {
    ...
    Audino: { nfe: true },
    Kangaskhan: { nfe: true },
    Floette: { otherFormes: ['Floette-Eternal', 'Floette-Ange'] },
    Glimmora: { nfe: true },
    Mawile: { nfe: true },
    Medicham: { nfe: true },
    Houndoom: { nfe: true },
    ...
    Scorchyvern: {
        types: ['Fire', 'Ground'],
        bs: { hp: 110, at: 113, df: 96, sa: 82, sd: 109, sp: 72 },
        weightkg: 100.5,
        abilities: { 0: 'Drought' }
    },
    Tortonate: {
        types: ['Water'],
        bs: { hp: 84, at: 93, df: 110, sa: 130, sd: 115, sp: 38 },
        weightkg: 101.1,
        abilities: { 0: 'Mega Launcher' }
    },
    Beewark: {
        types: ['Bug', 'Ground'],
        bs: { hp: 115, at: 90, df: 90, sa: 45, sd: 80, sp: 75 },
        weightkg: 40.5,
        abilities: { 0: 'Adaptability' }
    },
    Pidgeaether: {
    ...
    Gorochu: {
        types: ['Electric', 'Fire'],
        bs: { hp: 80, at: 115, df: 100, sa: 50, sd: 90, sp: 110 },
        weightkg: 38,
        abilities: { 0: 'Electric Surge' }
    },
    Pikaraichu: {
        types: ['Electric', 'Fighting'],
        bs: { hp: 80, at: 80, df: 65, sa: 110, sd: 90, sp: 120 },
        weightkg: 26,
        abilities: { 0: 'No Guard' }
    },
    Cryognaw: {
        types: ['Ice', 'Dark'],
        bs: { hp: 80, at: 110, df: 100, sa: 80, sd: 80, sp: 110 },
        weightkg: 350.2,
        abilities: { 0: 'Strong Jaw' }
    },
    Snorest: {
        types: ['Grass', 'Ice'],
        bs: { hp: 110, at: 97, df: 90, sa: 97, sd: 100, sp: 70 },
        weightkg: 185,
        abilities: { 0: 'Snow Warning' }
    },
    Freezeress: {
        types: ['Ice', 'Ghost'],
        bs: { hp: 80, at: 80, df: 70, sa: 110, sd: 100, sp: 120 },
        weightkg: 29.6,
        abilities: { 0: 'Snow Warning' }
    },
    Crabarbarian: {
        types: ['Fighting', 'Ice'],
        bs: { hp: 107, at: 153, df: 83, sa: 70, sd: 72, sp: 48 },
        weightkg: 252.8,
        abilities: { 0: 'Iron Fist' }
    },
    Wrecksadrill: {
        types: ['Ground', 'Rock'],
        bs: { hp: 110, at: 137, df: 83, sa: 52, sd: 70, sp: 98 },
        weightkg: 60,
    ...
    Goldeliath: {
        types: ['Ground', 'Ghost'],
        bs: { hp: 119, at: 144, df: 90, sa: 50, sd: 90, sp: 50 },
        weightkg: 330,
        abilities: { 0: 'Unseen Fist' }
    },
    Wooluster: {
        types: ['Electric', 'Dragon'],
        bs: { hp: 110, at: 75, df: 95, sa: 125, sd: 100, sp: 55 },
        weightkg: 61.5,
        abilities: { 0: 'Mold Breaker' }
    },
    Asperitazul: {
        types: ['Dragon', 'Fairy'],
        bs: { hp: 75, at: 70, df: 110, sa: 110, sd: 105, sp: 80 },
        weightkg: 20.6,
        abilities: { 0: 'Pixilate' }
    },
    Taxelmatose: {
        types: ['Normal', 'Poison'],
        bs: { hp: 85, at: 126, df: 86, sa: 54, sd: 96, sp: 115 },
        weightkg: 28.3,
        abilities: { 0: 'Scrappy' }
    },
    Aufcorse: {
        types: ['Normal', 'Fairy'],
        bs: { hp: 123, at: 90, df: 96, sa: 70, sd: 96, sp: 50 },
        weightkg: 32,
        abilities: { 0: 'Healer' }
    },
    Strechterror: {
        types: ['Ghost', 'Rock'],
        bs: { hp: 60, at: 130, df: 60, sa: 65, sd: 75, sp: 110 },
        weightkg: 40.5,
        abilities: { 0: 'Long Reach' }
    },
    Kangesa: {
        types: ['Normal', 'Ground'],
        bs: { hp: 115, at: 95, df: 90, sa: 60, sd: 90, sp: 90 },
        weightkg: 100,
        abilities: { 0: 'Parental Bond' }
    },
    'Floette-Ange': {
        types: ['Fairy', 'Dark'],
        bs: { hp: 74, at: 85, df: 94, sa: 135, sd: 138, sp: 28 },
        weightkg: 100.8,
        abilities: { 0: 'Fairy Aura' },
        baseSpecies: 'Floette'
    },
